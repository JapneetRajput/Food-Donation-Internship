...
public class Small extends AppCompatActivity {
    ...
    TextInputEditText quantity,desc,address1, address2;
    Button donate;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.collection("SmallOrders").document(uid).set(bulk).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(Small.this, "Updated successfully", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(Small.this,MainActivity.class));
                            finish();
                        }
                        else{
                            Toast.makeText(Small.this, "Update failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
